...
public class kakaoService implements IKakaoService{
	...
	public String getAuthcode() throws Exception {
		...
		final String RESTAPI_KEY = "27c978dd34db046ade506b3d1fb46013"; // 우리 집 열쇠
		final String Redirect_URI = "http://localhost:8080/kakaoLogin.do"; // 카카오에 등록한 요청 url
		// 카카오 SAMPLE Request 예제 참고
		String  SampleRequest= "https://kauth.kakao.com/oauth/authorize?response_type=code&client_id="; // 카카오 접속 앤드포인트  url
	...
	public String getAccessToken(String code) throws Exception {
		...
		String RESTAPI_KEY = "27c978dd34db046ade506b3d1fb46013";
